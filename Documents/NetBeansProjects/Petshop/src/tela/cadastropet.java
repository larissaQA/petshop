...
public class cadastropet extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 40, 20));

        jLabel5.setText("Nascimento");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 170, -1, -1));
        getContentPane().add(txtNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 50, 102, -1));
        ...
        getContentPane().add(txtDono, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, 102, -1));
        getContentPane().add(txtEspecie, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 110, 102, -1));
        getContentPane().add(txtSexo, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 140, 102, -1));
        ...
        getContentPane().add(txtData, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 170, 102, -1));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/petshop/download.jpg"))); // NOI18N
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 10, 240, 200));

        jLabel7.setForeground(new java.awt.Color(255, 0, 204));
        jLabel7.setText("PETSHOP DA LALÁ");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      pet p = new pet();
        ...
        p.setDono(txtDono.getText());
        p.setEspecie(txtEspecie.getText());
        p.setSexo(txtSexo.getText());
        p.setNascimento(txtData.getText());
        dao.create(p);
